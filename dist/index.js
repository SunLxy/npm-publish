...
var request=/*#__PURE__*/function(){var _ref=_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(options,tag,newEntries){var assets,json;return _regeneratorRuntime().wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:if(!(Array.isArray(newEntries)&&newEntries.length)){_context2.next=7;break;}_context2.next=3;return Promise.all(newEntries.map(/*#__PURE__*/function(){var _ref2=_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(item){var json;return _regeneratorRuntime().wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.next=2;return lib_default()(_objectSpread2(_objectSpread2({},options),{},{tag:tag||item.tag,"package":item["package"]}));case 2:json=_context.sent;return _context.abrupt("return",json);case 4:case"end":return _context.stop();}}},_callee);}));return function(_x4){return _ref2.apply(this,arguments);};}()))["catch"](function(error){throw error;});case 3:assets=_context2.sent;return _context2.abrupt("return",assets);case 7:if(!options["package"]){_context2.next=14;break;}_context2.next=10;return lib_default()(_objectSpread2({},options));case 10:json=_context2.sent;return _context2.abrupt("return",json);case 14:throw'package is empty';case 15:case"end":return _context2.stop();}}},_callee2);}));return function request(_x,_x2,_x3){return _ref.apply(this,arguments);};}();
